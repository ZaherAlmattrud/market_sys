                                ...
                                <v-container>
                                    <v-row>
                                        <v-col cols="12" sm="6" md="12">
                                            <v-text-field v-model="editedItem.arresteds"
                                                label="المقبوضات"></v-text-field>
                                        </v-col>
                                    </v-row>
                                    <v-row>
                                        <v-col cols="12" sm="6" md="12">
                                            <v-text-field v-model="editedItem.paids" label="المدفوعات"></v-text-field>
                                        </v-col>
                                    </v-row>
                                    <v-row>
                                        <v-col cols="12" sm="6" md="12">
                                            <v-text-field v-model="editedItem.box" label="الصندوق"></v-text-field>
                                        </v-col>
                                    </v-row>
