                ...
                <v-container>
                  <v-row>
                    <v-col cols="12" sm="6" md="6">
                      ...
                      <v-autocomplete v-model="editedItem.account_id" :items="users" item-title="user_name"
                        item-value="id" label="صاحب الفاتورة" placeholder="ابدأ البحث" crearable>
                      </v-autocomplete>
                    </v-col>
                    <v-col cols="12" sm="6" md="6">
                      <v-text-field v-model="editedItem.total" label="الرصيد الإجمالي"></v-text-field>
                    </v-col>
                  </v-row>
                  <v-row>
                    <v-col cols="12" sm="6" md="6">
                    ...
                    <v-col cols="12" sm="6" md="6">
                      <v-text-field v-model="editedItem.num" label="رقم الفاتورة المطبوع"></v-text-field>
                    </v-col>
                  </v-row>
                </v-container>
              </v-card-text>
