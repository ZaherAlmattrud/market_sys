                  ...
                  <v-row>
                    <v-col cols="12" md="8" sm="12">
                      <v-combobox
                        ...
                        crearable
                        variant="outlined"
                        @update:modelValue="addProductInfo"
                      >
                      </v-combobox>
                    </v-col>
...
export default {
  ...
  methods: {
    addProductInfo() {
      ...
      if (this.editedItem.name && typeof this.editedItem.name == "object") {

        itemName = this.editedItem.name.name;
      } else {
      ...
      if (item) {
        ...
        this.editedItem.category_id =   item.category_id;
        this.editedItem.code =  item.code;
        this.editedItem.sell=  item.sell ;
